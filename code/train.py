...
if __name__  == "__main__":
    ...
    trainer = Trainer(lr=args.lr,epochs=args.epochs,batch_size= args.batch_size,step_size= args.step_size)
    ...
    print("He init train")
    he_init_trainer = Trainer(lr=args.lr,epochs=args.epochs,initiliaztion='He init',batch_size= args.batch_size,step_size= args.step_size)
    ...
    weights_trainer = Trainer(lr=args.lr,epochs=args.epochs,use_weights=True,batch_size= args.batch_size,step_size= args.step_size)
    ...
    dynamic_lr_trainer = Trainer(lr=args.lr,epochs=args.epochs,adjust_lr= True,batch_size= args.batch_size,step_size= args.step_size)
    ...
    regular_trainer = Trainer(lr=args.lr,epochs=args.epochs,is_regular= True,batch_size= args.batch_size,step_size= args.step_size)
